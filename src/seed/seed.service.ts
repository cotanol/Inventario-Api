...
export class SeedService {
  ...
  private async deleteTables() {
    await this.dataSource.query(
      'TRUNCATE TABLE "movimientos_inventario", "detalles_compra", "compras", "detalles_pedido", "pedidos", "proveedores", "usuarios", "perfiles", "permisos", "usuarios_perfiles", "permisos_perfiles", "inventarios", "productos", "marcas", "grupos", "lineas", "clientes", "vendedores" RESTART IDENTITY CASCADE',
    );
  }
