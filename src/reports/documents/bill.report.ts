    ...
    content: [
      ...
      // Tabla con los datos del pedido
      {
        ...
        table: {
          ...
          body: [
            [
              { text: 'ID', alignment: 'center' as Alignment },
              'Producto',
              'Precio',
              'Cantidad',
              'Total',
            ...
            ...billProducts.map((product) => [
              { text: product.ID, alignment: 'center' as Alignment },
              product.Producto,
            ...
            [{}, {}, {}, {}, {}],
            [
              { text: 'Subtotal', colSpan: 4, alignment: 'right' as Alignment },
              {},
              {},
              {},
              {
            ...
            [
              { text: 'IVA 16%', colSpan: 4, alignment: 'right' as Alignment },
              {},
              {},
              {},
              {
