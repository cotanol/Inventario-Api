  ...
  const docDefinition: TDocumentDefinitions = {
    ...
    content: [
      ...
      // Notas
      {
        margin: [0, 30, 0, 0],
        stack: [
          { text: 'CONDICIONES:', style: 'subheader', fontSize: 11 },
          {
            ul: [
              'Esta orden de compra es vinculante una vez aceptada por el proveedor.',
              'Los productos deben cumplir con las especificaciones técnicas acordadas.',
              'En caso de retraso, favor notificar con anticipación.',
              'Cualquier cambio debe ser aprobado por escrito.',
            ],
            fontSize: 9,
            margin: [0, 5, 0, 0],
          },
