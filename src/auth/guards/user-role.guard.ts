...
export class UserRoleGuard implements CanActivate {
  ...
  canActivate(
    ...
    // Extraemos los nombres de los perfiles del usuario
    const userRoles = user.perfilesLink.map((link) => link.perfil.nombre);
    ...
    throw new ForbiddenException(
      `User ${user.nombres + ' ' + user.apellidoPaterno} need a valid role: [${validRoles}]`,
